    ...
    <div className="min-h-screen w-full flex flex-col items-center pt-32 pb-24 px-6 relative overflow-hidden bg-background">
      ...
      <div className="max-w-4xl w-full z-10">
        <div className="text-center mb-16">
          ...
          >
            ISO <span className="text-accent italic">27001</span>
          </motion.h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          ...
          >
            <h2 className="text-2xl font-black tracking-kairo uppercase mb-6 text-bone">Why ISO 27001?</h2>
          ...
          >
            ...
            >
              Secure Your Business <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </a>
          </motion.div>
        </div>
      </div>
